...
\begin{tikzpicture}[x=1cm,y=1cm,>=Stealth,font=\fontsize{7}{8}\selectfont,
...
\node[latent,text width=1.65cm] (offset) at (1.2,0) {Lateral offset\\$x$};
\node[weight,text width=1.2cm] (weight) at (-.6,-1.35) {Centering\\weight};
\node[op,text width=1.1cm] (mul) at (1.2,-1.35) {multiply};
\node[latent,text width=1.65cm] (center) at (1.2,-2.55) {Centering\\contribution};
\node[latent,text width=1.85cm] (other) at (5.5,-3.65) {Other steering\\contributions};
\node[op,text width=1.1cm] (sum) at (5.5,-4.5) {add};
...
\ifincrementaledit
 ...
 \node[weight,new,text width=1.25cm] (strength) at (3.4,-1.35)
   {Off-track strength\\$k\geq0$};
 \node[op,new,text width=1.75cm,draw=teal!65!black] (product) at (5.5,-1.35)
   {multiply, then $+1$};
 \node[latent,new,text width=1.85cm] (recovery) at (5.5,-2.55)
   {Recovery\\multiplier};
 \node[op,new,text width=1.1cm,draw=teal!65!black] (boost) at (1.2,-4.5)
   {multiply};
